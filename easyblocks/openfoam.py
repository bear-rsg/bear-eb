...
class EB_OpenFOAM(EasyBlock):
    ...
    def extract_step(self):
        ...
        toolBinPath = [file.path for file in os.scandir(os.path.join(openfoam_installdir, "bin"))]
        toolBinPath += [file.path for file in os.scandir(os.path.join(openfoam_installdir, "wmake"))]
